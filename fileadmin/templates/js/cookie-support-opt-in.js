...
HI.optInCookies = {
	...
	l10n: {
		...
		queryBody: "By using this website you are agreeing\n to store cookies from this website",
		queryTail: "Close Notification",
	...
	showQuery: function() {
		...
		agree_button.className = "hi-cookie-btn disagree";
