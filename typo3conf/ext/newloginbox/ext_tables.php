<?php
# TYPO3 CVS ID: $Id: ext_tables.php 5217 2007-03-21 07:53:17Z stradarius $
...
t3lib_extMgm::addPlugin(Array('LLL:EXT:newloginbox/locallang_db.xml:tt_content.list_type1', $_EXTKEY.'_pi1'),'list_type');
t3lib_extMgm::addPlugin(Array('LLL:EXT:newloginbox/locallang_db.xml:tt_content.list_type3', $_EXTKEY.'_pi3'),'list_type');
