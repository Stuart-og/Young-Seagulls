...
$db->exec('
	INSERT INTO tx_ggfanzonemessages_messages (pid, tstamp, crdate, hidden, user_uid, message, response_to)
	VALUES(
		' . $pid . ',
		' . time() . ',
		' . time() . ',
...
$mail_message = "The following comment to a message has been posted to Gully's Gang - ".$comment.".\n\nLog into the TYPO3 CMS to approve this message";
