...
/**
 * Plugin 'TS Home Wall' for the 'ts_wall' extension.
 *
 * @author	 <>
 * @package	TYPO3
 * @subpackage	tx_tswall
 */
class tx_tswall_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_tswall_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_tswall_pi1.php';	// Path to this script relative to the extension dir.
	...
	function main($content, $conf) {
		...
		$res = $GLOBALS['TYPO3_DB']->sql(TYPO3_db, 'SELECT * FROM  tx_tswall_posts WHERE deleted != 1 AND hidden != 1 AND response_to = "" ORDER BY uid DESC LIMIT 5');
		...
		$content='
				<div class="above">
				  <a href="/team-stripes/the-wall/" class="button">More</a>';
		if (!$logged_in) {
			$content .= '<a href="/team-stripes/login/" class="button">Login</a>';
		}
		$content .= '
				  <h2>Team Stripes <span class="white">Wall</span></h2>
				  '.$messages.'
				</div>
				<img src="fileadmin/ts-templates/img/home/Chat.png" alt="Chat" class="bottomleft imgalpha" />
			    <div class="clearer"></div>';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ts_wall/pi1/class.tx_tswall_pi1.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ts_wall/pi1/class.tx_tswall_pi1.php']);
}
