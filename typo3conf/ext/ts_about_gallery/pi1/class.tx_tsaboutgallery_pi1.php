...
/**
 * Plugin 'TS About Gallery' for the 'ts_about_gallery' extension.
 *
 * @author	 <>
 * @package	TYPO3
 * @subpackage	tx_tsaboutgallery
 */
class tx_tsaboutgallery_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_tsaboutgallery_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_tsaboutgallery_pi1.php';	// Path to this script relative to the extension dir.
	var $extKey        = 'ts_about_gallery';	// The extension key.
	...
	function main($content, $conf) {
		...
		*/
		...
		<div class="slideshow-container carbonbox h25">
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ts_about_gallery/pi1/class.tx_tsaboutgallery_pi1.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ts_about_gallery/pi1/class.tx_tsaboutgallery_pi1.php']);
}
