...
<form action="register.php" method="post">
	...
	<div class="form-item">
		...
		<input id="parent" type="text" name="parent"  maxlength="20" <?php if( $parent ){ echo "value='".$parent."'"; } ?> />
		<?php if( $parent_err ){ echo $parent_err; } ?>
	</div>
	...
	<div class="form-item">
    <label for="htmlnewsletter">Receive contact via email</label>
    <input id="htmlnewsletter" type="checkbox" name="htmlnewsletter" value="y" />
	</div>
