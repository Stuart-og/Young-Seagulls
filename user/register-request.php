<?php
	...
	$htmlnewsletter = trim($_POST['htmlnewsletter']);
	...
	if( strlen($parent) < 1 ){
		$parent_err = "<div id='parent-err' class='err' >*Please enter your parent/guardians name</div>";
		$err = true;
	}
				      ...
				      <Site>
				        ...
				        <Contacts Total='1'>
				          <Contact>
				            ...
				            <HTMLNewsletter>$newsletter</HTMLNewsletter>
